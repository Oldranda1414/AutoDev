...
1. **Business Requirements**
    ...
    1. AutoDev should increase the adoption of reproducible dev envs across development teams.
...
1. **Functional Requirements**
    1. **User Functional Requirements**
        ...
        1. Error handling
            ...
            1. Users should be given tips for fixing errors when they occur.
    1. **System Functional Requirements**
        1. AutoDev should use an LLM model to generate the `flake.nix` file.
        1. AutoDev should provide a default prompting style for all available LLMs.
